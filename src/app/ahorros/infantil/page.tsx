                ...
                <div className="container relative mx-auto px-6 z-10">
                    ...
                    <div className="flex items-start gap-6">
                        <div className="hidden md:flex h-20 w-20 items-center justify-center rounded-2xl bg-primary-gold/20 backdrop-blur">
                            <Baby className="h-10 w-10 text-primary-gold" />
                        </div>
                        <div>
                            <h1 className="font-heading text-4xl font-bold text-white md:text-5xl lg:text-6xl mb-4">
                                Ahorro <span className="text-primary-gold">Infantil</span>
                            </h1>
                            <p className="text-xl text-white/80 max-w-2xl">
                                Siembra el hábito del ahorro desde temprana edad. Una cuenta especial
                                para que los más pequeños aprendan el valor del dinero.
                            </p>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="grid gap-12 lg:grid-cols-3">
                        <div className="lg:col-span-2">
                            ...
                            <div className="grid gap-4 sm:grid-cols-2 mb-8">
                                {[
                                    "Disponible en el mes de cumpleaños",
                                    "Fomenta el hábito del ahorro",
                                    "Cuenta a nombre del menor",
                                    "Material educativo financiero",
                                    "Sin monto mínimo de apertura",
                                    "Beneficios especiales por cumpleaños",
                                ].map((item) => (
                            ...
                            <div className="grid gap-4 sm:grid-cols-3 mb-8">
                                <div className="flex items-center gap-3 p-4 rounded-xl bg-primary-blue/5 border border-primary-blue/10">
                                    <Cake className="h-6 w-6 text-primary-gold" />
                                    <span className="text-gray-700 font-medium">Cumpleaños</span>
                                </div>
                                <div className="flex items-center gap-3 p-4 rounded-xl bg-primary-blue/5 border border-primary-blue/10">
                                    <BookOpen className="h-6 w-6 text-primary-gold" />
                                    <span className="text-gray-700 font-medium">Educación</span>
                                </div>
                                <div className="flex items-center gap-3 p-4 rounded-xl bg-primary-blue/5 border border-primary-blue/10">
                                    <Heart className="h-6 w-6 text-primary-gold" />
                                    <span className="text-gray-700 font-medium">Metas infantiles</span>
                                </div>
                            </div>
                        </div>
