                ...
                <div className="grid gap-12 md:grid-cols-2 lg:grid-cols-4">
                    ...
                    <div className="lg:col-span-1">
                        ...
                        <div className="flex gap-4">
                            <a
                                href="https://www.facebook.com/share/1DcNsn1N8s/?mibextid=wwXIfr"
                                target="_blank"
                            ...
                            <a
                                href="https://www.instagram.com/crece.finance?igsh=MTU3Mzl1Y202cGdscQ=="
                                target="_blank"
                                rel="noopener noreferrer"
                                className="flex h-10 w-10 items-center justify-center rounded-lg bg-white/10 text-white transition-all hover:bg-primary-gold hover:text-primary-blue border border-white/10 hover:border-primary-gold"
                            ...
                            <a
                                href="https://www.tiktok.com/@crece.finance?_r=1&_t=ZM-9369r4jX6rL"
                                target="_blank"
                                rel="noopener noreferrer"
                                className="flex h-10 w-10 items-center justify-center rounded-lg bg-white/10 text-white transition-all hover:bg-primary-gold hover:text-primary-blue border border-white/10 hover:border-primary-gold"
                                aria-label="TikTok"
                            ...
                            <a
                                ...
                                className="flex h-10 w-10 items-center justify-center rounded-lg bg-white/10 text-white transition-all border border-white/10 opacity-50 cursor-not-allowed"
